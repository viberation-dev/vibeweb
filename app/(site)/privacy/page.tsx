  ...
  return (
    <main className="mx-auto w-full max-w-3xl space-y-8 p-6 pb-16">
      ...
      <p className="text-muted-foreground">
        Viberation is a curated directory of AI tools and guides for people
        learning to build with them. This policy explains what we collect, why
        we collect it, who else handles it, and what you can ask us to do with
        it. You can browse the entire site without an account; most of what
        follows applies only once you create one.
      </p>

      <Section title="1. Information we collect">
        <p className="text-muted-foreground">
          <strong className="text-foreground">Information you give us.</strong>{" "}
          When you create an account we store your email address and the
          username you choose. If you sign in with GitHub or Google instead of a
          password, that provider confirms your identity and gives us your email
          address — we never receive your password and cannot act on your
          account there.
        </p>
        <p className="text-muted-foreground">
        ...
        <p className="text-muted-foreground">
          ...
          click through to a tool&rsquo;s website we record that a click
          happened — which tool, and when. Nothing else. That record contains no
          user identifier, no IP address and no device information, and it is
          not linked to your account whether you are signed in or not.
        </p>
        <p className="text-muted-foreground">
          <strong className="text-foreground">Server logs.</strong> Our host
          produces ordinary web-server logs, which include IP addresses and
          browser user agents. See section 4.
        </p>
      </Section>
      ...
      <Section title="2. How we use it">
        ...
        <p className="text-muted-foreground">
          We do not use your information to build an advertising profile, and we
          do not make automated decisions about you that produce legal or
      ...
      <Section title="3. Cookies and tracking">
        ...
        <p className="text-muted-foreground">
          ...
          to keep you signed in and to keep that session secure. They are
          strictly necessary for the site to work, which is why you are not
          asked to consent to them. Signing out clears them.
        </p>
      </Section>
      ...
      <Section title="4. Who else handles your information">
        ...
        <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
          <li>
            ...
            database and handles sign-in and account security.
          </li>
          <li>
        ...
        <p className="text-muted-foreground">
          If you sign in with GitHub or Google, that provider necessarily learns
          that you signed in to Viberation. Their handling of that is governed
          by their own privacy policy.
        </p>
        <p className="text-muted-foreground">
          We may also disclose information where we are legally required to,
          where it is necessary to establish or defend a legal claim, or to
      ...
      <Section title="5. How long we keep it">
        <p className="text-muted-foreground">
          ...
          aggregate statistics; because they identify nobody, they are not
      ...
      <Section title="6. Security">
        ...
        <p className="text-muted-foreground">
          No service can promise perfect security, and we do not. If a breach
          affects your information we will notify you and any relevant regulator
          as required by law.
        </p>
      </Section>
      ...
      <Section title="7. International transfers">
        <p className="text-muted-foreground">
          Our providers operate globally, so your information may be stored or
          processed in a country other than the one you live in, including the
          United States. Where the law requires a safeguard for such transfers,
          we rely on our providers&rsquo; standard contractual protections.
        </p>
      </Section>

      <Section title="8. Your rights">
        <p className="text-muted-foreground">
          You can access and correct most of your information yourself: your
          username and preferences on your profile page, and your bookmarks
          wherever they appear.
        </p>
        <p className="text-muted-foreground">
          Depending on where you live, you may also have the right to obtain a
          copy of your information, have it corrected or deleted, object to or
          restrict how we use it, ask for it in a portable format, or withdraw
          consent. Residents of California and other US states with comparable
          laws have the right not to be treated differently for exercising these
          rights — and note that we do not sell or share personal information
          for cross-context behavioural advertising, so there is nothing to opt
          out of.
        </p>
        <p className="text-muted-foreground">
          There is currently no self-service delete button. To request a copy of
          your data, or to delete your account and everything attached to it,
          email{" "}
          <a
      ...
      <Section title="9. Children">
        <p className="text-muted-foreground">
          Viberation is not directed at children under 13, and we do not
      ...
      <Section title="10. Links to other sites">
        <p className="text-muted-foreground">
          The directory links out to third-party tools, and some of those links
          ...
          . Once you leave Viberation you are on someone else&rsquo;s site,
      ...
      <Section title="11. Changes to this policy">
        <p className="text-muted-foreground">
          ...
          page. If the change is significant we will make it more obvious than
          that.
        </p>
      </Section>
